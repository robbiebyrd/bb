...
| `INTERFACE_` (OBD: `elm327`\|`stn`) | `OBD_MODE` (`monitor`\|`poll`\|`hybrid`, default `monitor`), `OBD_PROTOCOL` (ELM327 `ATSP` selector; `6`=ISO15765 11/500 default, `7`=29/500, `0`=auto), `OBD_HW_FILTER` (comma-separated CAN IDs to pass in hardware), `OBD_PIDS` (comma-separated requests, e.g. `010C,010D`), `OBD_POLL_MS` (poll interval, default `1000`), `OBD_PORT_BAUD` (serial speed, default `115200`) |
